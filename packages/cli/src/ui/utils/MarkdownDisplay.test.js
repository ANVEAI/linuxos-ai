...
| Jane | 30  | LA   |
`;
            const { lastFrame } = render(<MarkdownDisplay text={tableMarkdown} isPending={false} terminalWidth={80}/>);
...
`;
            const { lastFrame } = render(<MarkdownDisplay text={mixedMarkdown} isPending={false} terminalWidth={80}/>);
...
`;
            const { lastFrame } = render(<MarkdownDisplay text={malformedMarkdown} isPending={false} terminalWidth={80}/>);
...
| ${'a'.repeat(20)} | ${'b'.repeat(20)} | ${'c'.repeat(20)} | ${'d'.repeat(20)} | ${'e'.repeat(20)} | ${'f'.repeat(20)} | ${'g'.repeat(20)} | ${'h'.repeat(20)} | ${'i'.repeat(20)} | ${'j'.repeat(20)} |
    `;
            const renderNarrow = () => render(<MarkdownDisplay text={wideTable} isPending={false} terminalWidth={40}/>);
...
#### H4 Header
`;
            const { lastFrame } = render(<MarkdownDisplay text={headerMarkdown} isPending={false} terminalWidth={80}/>);
...
\`\`\`
`;
            const { lastFrame } = render(<MarkdownDisplay text={codeMarkdown} isPending={false} terminalWidth={80}/>);
